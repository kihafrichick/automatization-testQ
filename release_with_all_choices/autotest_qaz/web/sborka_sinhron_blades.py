...
def log_except(module,action,e,comment):
    ...
    if "element not interactable" or "NewConnectionError" in error_msg:
        print (f'{module}:{action}:ERROR | Элемент страницы не доступен, проверьте ID элемента {comment}')
...
async def initialization_blade():
    try:
            ...
            comment='Кнопки "Войти" на странице авторизации'
...
async def tab_scan_blade():
    ...
    try:
        ...
        log_except('Quasar-2','Сканирование информации', e)
        return False
...
async def line_power_on_blade():
    try:
        ...
        log_except('Quasar-2','Включение клиентской и основных линий', e)
        return False
...
async def ALS_mode_change_blade():
    try:
        ...
        log_except('Quasar-2','Включение режима Управляется ALS', e)
        return False
...
async def FEC_mode_EFEC_blade(): 
    try:
        ...
        log_except('Quasar-2','Установка режима FEC', e)
        return False
...
async def FEC_mode_G709_blade():
    try:
        ...
        log_except('Quasar-2','Установка режима G.709', e)
        return False
...
async def FEC_mode_off_blade():
    try:
        ...
        log_except('Quasar-2','Установка режима Выкл.', e)
        return False
...
async def FEC_mode_G709_rep_blade():
    try:
        ...
        print('Quasar-2','Установка режима G.709', e)
        return False
...
async def ALS_status_ImpAuto_blade():
    try:
        ...
        log_except('Quasar-2','Установка режима Перезапуск импульсами', e)
        return False
...
async def ALS_status_AutoImp_blade():
    try:
        ...
        log_except('Quasar-2','Установка режима Перезапуск автоматический', e)
        return False
...
async def line_power_off_blade():
    try:
        ...
        log_except('Quasar-2','Выключение клиентской и основных линий', e)
        return False
