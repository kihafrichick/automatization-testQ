...
async def int_code2():
    try:
        driver.get("http://192.168.17.224")
    ...
    try:
        ...
        with open('info_224.txt', 'w', encoding='utf-8') as file:
...
async def function_12():
    try:
        driver.find_element(By.ID, "dev10st_descr").click()
        driver.find_element(By.ID, "ui-id-38").click()
        driver.find_element(By.CSS_SELECTOR, "#dev10_Ln1PortState .on-click-edit").click()
        ...
        driver.find_element(By.CSS_SELECTOR, "#dev10_Ln2PortState .on-click-edit").click()
        dropdown = driver.find_element(By.ID, "param_select_value")
        dropdown.find_element(By.XPATH, "//option[. = 'OOS-MT']").click()
        element = driver.find_element(By.ID, "param_select_value")
        actions = ActionChains(driver)
        ...
        driver.find_element(By.CSS_SELECTOR, "#dev10_Cl1PortState .on-click-edit").click()
        dropdown = driver.find_element(By.ID, "param_select_value")
        dropdown.find_element(By.XPATH, "//option[. = 'OOS-MT']").click()
        element = driver.find_element(By.ID, "param_select_value")
        actions = ActionChains(driver)
...
async def function_13():
    try:
        driver.find_element(By.CSS_SELECTOR, "#dev10_Ln1TxEnable .on-click-edit").click()
        driver.find_element(By.CSS_SELECTOR, f".ui-dialog:nth-child({path_number_1}) > .ui-dialog-buttonpane .ui-button:nth-child(2)").click()
        driver.find_element(By.CSS_SELECTOR, f".ui-dialog:nth-child({path_number_2}) > .ui-dialog-buttonpane .ui-button:nth-child(2)").click()
        
        driver.find_element(By.CSS_SELECTOR, "#dev10_Ln2TxEnable .on-click-edit").click()
        driver.find_element(By.CSS_SELECTOR, f".ui-dialog:nth-child({path_number_1}) > .ui-dialog-buttonpane .ui-button:nth-child(2)").click()
        driver.find_element(By.CSS_SELECTOR, f".ui-dialog:nth-child({path_number_2}) > .ui-dialog-buttonpane .ui-button:nth-child(2)").click()
        
        driver.find_element(By.CSS_SELECTOR, "#dev10_Cl1TxEnable .on-click-edit").click()
        driver.find_element(By.CSS_SELECTOR, f".ui-dialog:nth-child({path_number_1}) > .ui-dialog-buttonpane .ui-button:nth-child(2)").click()
        driver.find_element(By.CSS_SELECTOR, f".ui-dialog:nth-child({path_number_2}) > .ui-dialog-buttonpane .ui-button:nth-child(2)").click()
...
async def function_14():
    try:
        driver.find_element(By.CSS_SELECTOR, "#dev10_Ln1FECSet .on-click-edit").click()
        dropdown = driver.find_element(By.ID, "param_select_value")
        ...
        driver.find_element(By.CSS_SELECTOR, "#dev10_Ln2FECSet .on-click-edit").click()
        dropdown = driver.find_element(By.ID, "param_select_value")
        dropdown.find_element(By.XPATH, "//option[. = 'EFEC']").click()
        element = driver.find_element(By.ID, "param_select_value")
        actions = ActionChains(driver)
...
async def function_18():
    try:
        driver.find_element(By.CSS_SELECTOR, "#dev10_Ln1ALSSet .on-click-edit").click()
        dropdown = driver.find_element(By.ID, "param_select_value")
        ...
        driver.find_element(By.CSS_SELECTOR, "#dev10_Ln2ALSSet .on-click-edit").click()
        dropdown = driver.find_element(By.ID, "param_select_value")
        dropdown.find_element(By.XPATH, "//option[. = 'Перезапуск импульсами']").click()
        element = driver.find_element(By.ID, "param_select_value")
        actions = ActionChains(driver)
        ...
        driver.find_element(By.CSS_SELECTOR, "#dev10_Cl1ALSSet .on-click-edit").click()
        dropdown = driver.find_element(By.ID, "param_select_value")
        dropdown.find_element(By.XPATH, "//option[. = 'Перезапуск импульсами']").click()
        element = driver.find_element(By.ID, "param_select_value")
        actions = ActionChains(driver)
...
async def function_22():
        driver.get('http://192.168.17.224/slot-10/')
        await asyncio.sleep(5)
        ...
        try:
            ...
            with open('output-journal_224.txt', 'w', encoding='utf-8') as file:
