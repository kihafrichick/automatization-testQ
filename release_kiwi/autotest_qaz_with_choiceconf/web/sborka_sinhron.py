...
async def initialization():
    try:
        ...
        print(f"Quasar-1:Переход на страницу и авторизация:ERROR -> {str(e)}")
        return False
...
async def tab_scan():
    try:
        ...
        print(f"Quasar-1:Сканирование информации:ERROR -> {str(e)}")
        return False
...
async def line_power_on():
    try:    
        ...
        print(f"Quasar-1:Включение клиентской и основных линий:ERROR -> {str(e)}")
        return False
...
async def ALS_mode_change():
    try:
        ...
        print(f"Quasar-1:Включение режима 'Управляется ALS':ERROR -> {str(e)}")
        return False 
...
async def FEC_mode_EFEC():
    try:
        ...
        print(f"Quasar-1:Установка режима 'FEC':ERROR -> {str(e)}")
        return False
...
async def FEC_mode_G709():
    try:
        ...
        print(f"Quasar-1:Установка режима 'G.709':ERROR -> {str(e)}")
        return False
...
async def FEC_mode_off():
    try:   
        ...
        print(f"Quasar-1:Установка режима 'Выкл.':ERROR -> {str(e)}")
        return False
...
async def ALS_status_AutoImp():
    try:
        ...
        print(f"Quasar-1:Установка режима 'Перезапуск автоматический':ERROR -> {str(e)}")
        return False
...
async def ALS_status_ImpAuto():
    try:
        ...
        print(f"Quasar-1:Установка режима 'Перезапуск импульсами':ERROR -> {str(e)}")
        return False
...
async def line_power_off():
    try:
        ...
        print(f"Quasar-1:Выключение клиентской и основных линий:ERROR -> {str(e)}")
        return False
